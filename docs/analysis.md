...
Student intake: 200 students processed in this run.
...
Duplicate student IDs removed during ingestion: 0. All data quality
...
LLM usage this run: 5 API calls, 13598 tokens total
(10961 input + 2637 output). Fallbacks triggered: 34.
